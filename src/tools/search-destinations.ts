...
export function registerSearchDestinations(server: McpServer, client: CheapereSIMClient): void {
    server.registerTool(
        ...
        {
            description:
                'Find countries CheapereSIM sells eSIM plans for, by full or partial name. Use this when the user names a place and you need its country code before looking up plans.',
